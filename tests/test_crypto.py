...
from secure_query.crypto import ensure_keys, get_public_key_pem, decrypt_b64url_payload, _b64url_to_bytes
...
def test_decrypt_b64url_payload_invalid_ciphertext(test_settings, monkeypatch):
    ...
    invalid_ciphertext = base64.urlsafe_b64encode(b"invalid ciphertext").decode('ascii').rstrip('=')
